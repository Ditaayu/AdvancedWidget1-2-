...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llAnak = (LinearLayout) findViewById(R.id.linearLayoutMain);
        ...
        spJumlah.setOnClickListener(new AdapterView.OnItemClickListener()
        {
            @Override
    ...
    private void doProses()
    {
        ...
        {
            LinearLayout llNow = (LinearLayout) llAnak.findViewById("Anak"+i);
